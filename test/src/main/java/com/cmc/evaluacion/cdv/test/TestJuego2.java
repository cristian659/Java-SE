...
public class TestJuego2 {
	...
	public void validarCartasTest() {
		...
		// assertNotEquals(carta1.getNumero().getNumeroCarta(),
		// carta2.getNumero().getNumeroCarta());
		// assertNotEquals(carta2.getNumero().getNumeroCarta(),
		// carta3.getNumero().getNumeroCarta());
		// assertNotEquals(carta3.getNumero().getNumeroCarta(),
		// carta4.getNumero().getNumeroCarta());
		// assertNotEquals(carta4.getNumero().getNumeroCarta(),
		// carta5.getNumero().getNumeroCarta());
	}
}
